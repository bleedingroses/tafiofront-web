...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::statement("
            ...
            (SELECT id_belanjastok, data_kontaks.id, nota, diskon, total, tanggal_input, tanggal, " . $company_id . " FROM lama_k_belanjastok
            left JOIN data_kontaks on (lama_k_belanjastok.id_supplier = data_kontaks.id_supplier and data_kontaks.company_id=" . $company_id . "))
        ");
    }
